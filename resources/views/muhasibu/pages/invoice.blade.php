                            ...
                            <div class="col-12">
                                                ...
                                                <div class="auth-logo">
                                                    <div class="logo logo-dark">
                                                        <span class="logo-lg">
                                                            ...
                                                            <h4>Yaronga Enterprises <span class="text-primary">Company Limited</span> </h4>
                                                        </span>
                                                    </div>
                             ...
                             <h6>Billing Address</h6>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-sm-6">
                                                <address>
                                                    ...
                                                    Dodoma City, Tanzania<br>
                                                    <abbr title="Phone">P:</abbr> (+255) 456-7890
                                                </address>
                                            </div> <!-- end col -->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="float-end">
                                                    <p><b>Sub-total:</b> <span class="float-end">Tsh:4597.50/=</span></p>
                                                    <h3>Tsh:4597.50/=</h3>
                                                </div>
                                        ...
                                        <div class="mt-4 mb-1" >
                                            <div class="text-end d-print-none">
                                                ...
                                                <a href="#" class="btn btn-info waves-effect waves-light">Send to Prove</a>
                                            </div>
                                        </div>
